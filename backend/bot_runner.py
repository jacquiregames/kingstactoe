        ...
        while True:
            ...
            async with state.state_lock:
                ...
                if game is None or game.is_round_over or game.is_game_over:
                    return
                if game.pending_undo is not None:
                    # Table is waiting on a human vote - don't let a bot
                    # barrel ahead. Whoever resolves the vote will call
                    # schedule_bot_turns() again afterwards.
                    return
